...
const navigation = {
  solutions: [
    ...
    { name: 'Home Security', href: '/services/security-systems' },
  ],
  support: [
...
const PublicFooter = () => {
  return (
    <footer className="relative bg-white dark:bg-slate-900" aria-labelledby="footer-heading">
      {/* Top Border with Gradient */}
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent dark:via-slate-700"></div>
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-slate-600 dark:text-slate-400">
              Connecting you with trusted home service professionals across South Africa.
            </p>
